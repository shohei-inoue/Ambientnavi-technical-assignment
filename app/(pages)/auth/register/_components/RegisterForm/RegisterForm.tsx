...
const RegisterForm = () => {
  ...
  return (
    ...
    <RegisterBirthdayField title="生年月日" value={birthday} setValue={setBirthday}/>
    <RegisterMailField title="メールアドレス" value={mail} setValue={setMail}/>
    <RegisterPasswordField title="パスワード" value={password} setValue={setPassword}/>
